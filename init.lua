...
-- Make j and k move between display lines instead of real lines
...
require('lazy').setup({
  ...
  --           if require('copilot-lsp.nes').walk_cursor_start_edit() then
  --             return nil
  --           end
  --           return '<C-o>'
  --         end, { desc = 'Jump to Copilot NES edit start', expr = true })
  --       end,
  --       config = function()
